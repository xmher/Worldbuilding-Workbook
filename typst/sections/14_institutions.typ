...
#section-title-page(
  ...
  intro: [Institutions aren't just settings. They're systems built to control, rank, test, and bind people, and in romantasy, the right institution becomes something wonderful for your story: a container your characters can't escape from. An institution will force characters to spend time together, build hierarchies they have to navigate, and create consequences that make leaving impossible or genuinely dangerous.],
)
...
== The Institutional Grip Principle
...
#strong[Primary institution type:]


#checklist(
  [Academy/Training Ground (education, magical training, warrior school)],
  [Court/Palace (political centre, noble society)],
  [Military/Wartime (army, navy, resistance, occupation)],
  [Religious Order (temple, monastery, priesthood)],
  [Economic/Labour (guild, apprenticeship, debt bondage, employment)],
  [Healing/Care (hospital, asylum, recovery)],
  [Prison/Captivity (imprisonment, hostage situation, magical confinement)],
  [Secret Society/Underground (resistance movement, thieves' guild, spy network, hidden order)],
  [Arranged Marriage (political alliance, forced union)],
  [Hybrid (combines multiple types)],
)


#strong[If hybrid, what elements combine?]


#hint[Example: A military academy combines military structure with an educational setting. A temple that trains warrior-priests combines religious and military. A royal court with magical rankings combines court politics with magical hierarchy.]
...
=== Which Tropes Does Your Institution Naturally Generate?


Different institutions may naturally foster different types of romantic relationships. You can certainly try to work against those natural pairings, but knowing which way your setting has a tendency to push will help.


You don't necessarily need your institution to develop into its "default" trope. But if you're writing an academy setting that somehow avoids all rivalry, proximity, and hierarchy, then ask yourself: are you getting the most out of your setting's advantages, or fighting them?
...
#open-table(
  headers: ("Trope", "Academy", "Court", "Military", "Religious", "Economic", "Captivity", "Arranged Marriage"),
  example-rows: (
    ([Forced proximity], [✓], [], [✓], [✓], [✓], [✓], [✓]),
    ([Enemies to lovers], [✓], [✓], [✓], [], [], [✓], [✓]),
    ([Forbidden love], [✓], [✓], [✓], [✓], [✓], [], []),
...
=== Mistake 1: The Institution Has No Teeth


#strong[What it looks like:] Your academy, court, or military has rules on paper, but nothing actually happens when characters break them. The institution threatens consequences but never delivers. Characters sneak around, violate protocols, and defy authority with no real fallout. The only thing stopping them from walking away is guilt or mild awkwardness.


#strong[Why it hurts:] If breaking the rules costs nothing, then following the rules means nothing. And if the institution's grip is weak, the romance loses its tension. "We shouldn't be together" only works as a story engine when "shouldn't" carries real weight. Your readers need to feel the danger every time your characters steal a moment together, and that danger has to come from the institution itself, not just from the characters feeling a bit nervous about it. Compare the Scholomance in Naomi Novik's series, where the school's protective mechanisms can and will kill you if you're careless, to an academy where the worst consequence for rule-breaking is a stern talking-to. One keeps you gripped. The other makes you wonder why the characters don't just leave.


#strong[How to fix it:] Before you write a single scene of stolen intimacy, write down exactly what happens if they get caught. Not "someone would be disappointed" but the specific, named consequence. Expulsion. Execution. Exile. Loss of magic. The institution needs to have already punished someone for this exact thing, so the threat is proven, real, and not hypothetical.


=== Mistake 2: The Institution Disappears Mid-Story


#strong[What it looks like:] The academy's ranking system, the court's surveillance, or the military's chain of command matters intensely in Act 1 but is quietly forgotten once the romance gets going. The characters still technically exist within the institution, but its rules, schedules, and hierarchies stop shaping their behaviour. The institution becomes wallpaper.


#strong[Why it hurts:] The institution is supposed to be the pressure that makes the romance feel urgent and dangerous. When it fades into the background, you lose the container that was compressing your characters together. This is a version of what critics call "Main Character Syndrome" worldbuilding, where the external world stops reacting logically to the protagonists' actions because the author is focused on the emotional arc. In the ACOTAR series, for instance, the Night Court's governance structures and political responsibilities often vanish when the romantic plot takes centre stage, leaving a world that feels like it pauses when the main characters aren't looking at it.


#strong[How to fix it:] At every major romantic beat, ask yourself: "What is the institution doing right now?" If your characters are having a secret midnight conversation in the academy, who's doing bed checks? If they're stealing a kiss at court, whose spy network just clocked it? The institution should be a constant presence that shapes #emph[how] intimacy happens, not just #emph[whether] it happens. The best romantic moments in these kinds of stories happen #emph[because] of the institution's pressure, not in spite of it.


=== Mistake 3: The Institution Is Generic


#strong[What it looks like:] Your academy feels like every other fantasy academy. Your court could be swapped into any other romantasy with no changes. Your military doesn't reflect your world's specific magic, culture, or history. The institution is a stock setting with the serial numbers filed off.


#strong[Why it hurts:] If readers have seen this exact institution before, they'll predict every beat. More importantly, a generic institution can't do the specific work your romance needs. The whole point of designing an institution is that #emph[this] institution, with #emph[these] rules and #emph[this] hierarchy and #emph[this] particular corruption, creates the exact pressure that forces #emph[your] characters together in ways that wouldn't happen anywhere else. In #emph[The Cruel Prince], Holly Black's Fae court works because it operates on specifically Fae rules: they can't lie, contracts are magically binding, and words are literal weapons. That's not a generic court with pointed ears. It's a political system whose unique constraints shape every romantic interaction Jude and Cardan have. Strip those rules away and the romance falls apart.


#strong[How to fix it:] Take your institution and ask: "What about my world's magic, culture, or history makes this institution different from the same type of institution in another book?" If your academy has a ranking system, what's unique about how rankings work given your specific magic system? If your court has surveillance, is it magical or social or both, and how does that reflect your world's particular power structures? The institution should be so embedded in your world that it couldn't exist anywhere else.
...
The academy setting is romantasy gold because it combines forced proximity, competitive rankings, and high stakes in one package. Think of Basgiath War College in Fourth Wing, where riders are put into squads they didn't choose, ranked against each other in deadly challenges, and paired with dragons who might kill them on sight. The academy does the heavy lifting: it forces Violet and Xaden into the same space, creates a complicated power dynamic (he's a wingleader; she's a first-year), and ensures that every interaction carries life-or-death weight. You don't have to manufacture reasons for your characters to keep running into each other when the institution's schedule does it for you.

The best academy settings don't just teach; they threaten. If your characters could coast through without real consequences, then the institution loses its grip on them. The danger is what forces characters to rely on each other, compete against each other, or protect each other when they shouldn't.

#strong[What kind of academy is it?]
...
#strong[What makes your academy dangerous or high-stakes?]
...
#strong[How long do students stay?]


#hint[The length of time at the academy determines how much pressure builds. A single semester creates urgency; years create slow burn. The duration also affects how deeply the institution shapes your characters' identities.]
...
#strong[Does your academy have rankings? What determines rank?]
...
#strong[What do top-ranked students get? What happens to those at the bottom?]
...
#open-table(
  headers: ("Level", "What They Get", "Romantic Implication"),
  example-rows: (
...
#strong[What daily routines force interaction?]
...
#strong[What rules govern relationships between students?]
...
Court settings replace physical danger with social danger. Everything said is analysed, every glance is catalogued. Courts are excellent for slow-burn because intimacy must be stolen in brief moments. Jude can never merely speak to Cardan; every exchange occurs while being watched by a court that will destroy her for showing weakness or wanting the wrong person. The constraint isn't a locked door. It's knowing that one misread glance could unravel everything she's built. That's what makes court romance so tense: the characters are rarely in physical danger from each other, but they're in constant social danger from everyone else.

The danger doesn't have to be physical. Social ruin can be just as devastating in a court setting, and the threat of it keeps every interaction loaded with subtext. If your characters can't afford to be seen caring about each other, even a lingering look becomes an act of rebellion.

#strong[What makes your court dangerous?]
...
#strong[Who watches everyone, and why?]


#hint[The surveillance system determines what your characters can get away with. Magical scrying means nothing is truly private; a network of gossips means information travels unpredictably. The nature of the watching shapes how your characters steal their moments together.]
...
#strong[What would happen if they were seen together inappropriately?]
...
#strong[What rituals force interaction between people who'd otherwise avoid each other?]


#hint[#emph[(Reference Section 3 for cultural customs)] Dances, ceremonies, negotiations, festivals, religious observances, political marriages?]
...
War is an accelerator for everything. When you're facing death, all pretences fall away, and "we might die tomorrow" becomes a spark to create intimacy. The war in Fourth Wing isn't background noise; it's the reason Violet and Xaden are at Basgiath in the first place, and the reason every single flight they take could be their last. This sense of urgency does things to characters that peacetime can't: it makes them reckless with truths they'd normally guard, and desperate for connection they'd normally deny themselves.

#hint[(For warfare's political dimensions, see Section 5. Here we're focusing on how military settings function as romantic containers.)]
...
#strong[What does "we might die tomorrow" actually mean for them?]
...
#strong[Where do soldiers sleep, eat, recover?]
...
#strong[If they're on opposing sides, what brought them into contact?]
...
#hint[(For religious doctrine and beliefs, see Section 6. Here we're focusing on how religious institutions bind characters and complicate desire.)]

=== The Religious Setting

#strong[What religious institution are your characters part of or connected to?]
...
#strong[What is the institution's stated purpose?]
...
#strong[What vows or commitments does the institution require?]
...
#strong[Does either character have vows that conflict with the relationship?]


#structured-table(
  headers: ("", "Spiritual Consequence", "Social Consequence", "Practical Consequence"),
  example-rows: (
    ([Example: Vow of celibacy (priestess of the moon goddess)], [Loss of divine connection; magic fades], [Public disgrace; family disowns her], [Expelled from temple; loses home and income]),
  ),
  rows: (
...
#strong[What would the institution do if the relationship were discovered?]
...
Or must they choose? #emph[(Reference Section 6 for how religion might adapt or condemn)]
...
== Economic & Labour Institutions

Guilds, apprenticeships, indentured service, and debt bondage create obligation that binds as tightly as any lock.

#hint[(For economic systems generally, see Section 4. Here we're focusing on how economic institutions trap characters together and complicate the power dynamics of love.)]

=== The Economic Binding

#strong[What economic institution binds your characters?]
...
#strong[Why can't they simply leave?]
...
#strong[What's the power structure?]
...
#strong[What work forces them together?]
...
#strong[What risks does workplace romance create?]
...
#strong[What healing institution is involved?]
...
#strong[Why is one character there?]
...
#strong[What's the other character's role?]


#hint[Their role determines the initial power dynamic. A professional healer carries duty and ethical boundaries. A fellow patient shares vulnerability. A reluctant caretaker brings resentment that can transform into tenderness. Each starting point shapes the arc differently.]
...
#strong[What makes the patient vulnerable?]
...
#strong[What intimate care creates connection?]
...
#strong[What happens when recovery is complete?]
...
The arranged marriage forces intimacy before trust. Strangers are expected to figure out how to do everything related to domestic life, be close physically, and deal with political pressure all at the same time. In The Bridge Kingdom, Lara marries Aren as part of a political alliance, but she's been trained since childhood to destroy his kingdom from within. Her marriage to him isn't just an inconvenience; it's a mission, and every moment of genuine connection threatens to unravel the plan she was raised to execute. I think that's why arranged marriage provides such rich romantasy territory: the institution demands performance (act like a couple), and somewhere in the performance, real feeling starts leaking through.

#hint[(For marriage laws and customs, see Sections 3 and 5. Here we're focusing on how arranged marriage functions as a romantic container.)]

=== The Arrangement

#strong[Why is this marriage happening?]
...
#strong[Who arranged it? Do the characters have any say?]


#hint[Whether the characters had input shapes their initial attitude toward each other. A marriage imposed without consent breeds resentment that must be overcome. A marriage they reluctantly agreed to carries guilt and second-guessing. Either way, the arrangement is the inciting incident of the romance.]
...
#strong[What makes the marriage unbreakable?]
...
#strong[What intimacy is expected?]
...
#strong[Does the story begin before or after the marriage?]
...
#strong[If already married, what's their relationship like at the start?]
...
#strong[What happens behind closed doors when performance ends?]


#hint[The gap between the public act and the private reality is where the real relationship lives. When the audience is gone and the masks come off, what remains? Awkward silence? Relief? The unsettling realisation that they miss the pretence?]
...
#workbook-table(
  headers: ("Captivity Type", "What It Looks Like", "Romantic Effect"),
  rows: (
    ([Physical dungeon], [Literal imprisonment: cells, chains, stone walls. Feyre Under the Mountain in ACOTAR.], [Raw survival. Intimacy is desperate, born from shared trauma. The captor who shows unexpected mercy becomes magnetic.]),
    ([Gilded cage], [Comfortable confinement disguised as protection or privilege. Feyre in the Spring Court, Emilia in the underworld in #emph[Kingdom of the Wicked].], [Slow-building resentment. The captive must recognise the cage before she can fight it, and the love interest is often the one who helps her see the bars.]),
    ([Ritual isolation], [Confinement enforced by religious or cultural duty. Poppy as the Maiden in #emph[From Blood and Ash].], [The captive has been trained to accept her confinement as normal. The love interest's role is to make her question everything she was taught to believe.]),
    ([Geographic imprisonment], [Trapped by landscape rather than locks. Lara in Ithicana in #emph[The Bridge Kingdom], surrounded by storms, sharks, and impassable seas.], [The captive and captor are equally trapped. Neither can leave, which forces cooperation and creates a "we're in this together" bond.]),
    ([Magical binding], [Tethered by spell, bond, or bargain. Emilia and Wrath's marriage bond in #emph[Kingdom of the Wicked], Feyre's bargain with Rhysand.], [The binding is inescapable and intimate. It often reveals truths neither character wanted exposed, and the "I didn't choose this" resentment slowly becomes "I'm choosing to stay."]),
  ),
)
...
The balance of power in a captivity romance is what determines if the story lives or dies. The dynamic is inherently unequal, and that's the point, but it can't stay unequal. If it does, you haven't written a romance; you've written a story that endorses the captor's control.
...
#strong[What does the physical space of confinement look like?]
...
#strong[What intimacy does confinement force?]
...
#strong[When does your captive freely choose to stay (or return)?]


#hint[Your reader needs to see a moment where the captive has full information, the genuine power to leave, and chooses to stay anyway. Without this, the romance reads as coercion, not love. Design that moment.]
...
#strong[What kind of secret organisation are your characters part of?]

#hint[The type of organisation determines what's at stake. A resistance movement fighting tyranny carries moral weight. A thieves' guild operates on self-interest and loyalty codes. A spy network runs on deception. Each creates different romantic tension.]
...
#strong[How does someone join? What binds them to silence?]


#hint[Oaths, magical bonds, mutual blackmail, shared guilt, initiation rituals? The binding mechanism determines how trapped your characters are.]
...
#hint[Answer these for whichever institution type you're building.]
...
#strong[What does your institution claim to do?]
...
#strong[What does it actually do?]
...
#strong[Who benefits from this institution?]
...
#strong[Where are your characters in this hierarchy?]
...
#strong[Who knows how to game the system?]
...
#strong[Do your characters learn to work the system?]
...
#strong[Is there corruption they could exploit, or that threatens them?]
...
#strong[If my characters tried to walk away right now, what would stop them?]


If the answer is "nothing" or "they'd feel bad," your institution doesn't have enough grip.


#strong[Strong answers sound like:]
...
#strong[Weak answers sound like:]
...
#strong[What is that cost in your story?]
...
Your characters don't just exist within institutions. They're shaped by them, rebel against them, find cracks in them, and ultimately either escape them or change them. Build an institution with enough grip that your characters can't just walk away, and then watch them try anyway. The institution creates the pressure; how your characters respond reveals who they truly are.


#divider()


#hint[Back to Contents]
