...
#workbook-table(
  headers: ("Mechanism", "How It Works", "What It Creates"),
  rows: (
...
#strong[The Legendary Lovers Dynamic]
...
#strong[History Across Romantasy Subgenres]
...
#workbook-table(
  headers: ("Subgenre", "How History Functions", "What's Essential", "What's Optional"),
  rows: (
    ([Fae court (#emph[ACOTAR], #emph[The Cruel Prince])], [Ancient history as a permanent present; immortal witnesses collapse the distance between past and personal grudge], [Ancient foundation conflict; immortal witnesses; rigid court hierarchy], [Detailed folkloric accuracy; economic logistics]),
    ([Military/academy (#emph[Fourth Wing])], [Institutional memory and state propaganda; the academy controls the narrative and physicalises trauma through rebellion relics], [Recent/parental war; institutional propaganda; codified academy rituals], [Detailed military strategy; geography and maps]),
    ([Dark romantasy (#emph[From Blood and Ash])], [History as a foundational lie; the characters' understanding of reality is fundamentally wrong, and the romance catalyses a theological revolution], [The foundational social lie; traumatic personal backstory; predatory ruling class], [Detailed pantheon of gods; strict magic system rules]),
    ([Regency/historical-adjacent (#emph[Bridgerton])], [Social memory and the stakes of reputation; a single scandal can destroy a family for generations], [Class hierarchy (the Ton); reputation and scandal sheets; family legacy and inheritance], [Strict historical accuracy; scientific or industrial progress]),
    ([Vampire/immortal (#emph[Twilight], #emph[House of Salt and Sorrows])], [The individual as a living historical archive; personal memory across centuries creates a disparity between lovers], [Subjective longevity; memory disparity (perfect vs. hazy); theological or gothic mythos], [Global political context; historical period flavour]),
  ),
)
...
#strong[Which subgenre pattern does your story follow?]
...
#strong[Quick guide to what you need:]


- #strong[Enemies-to-lovers rooted in historical conflict?] Focus on: Building Your Timeline (especially Historical Conflicts), Family History & Inherited Wounds, and How People Relate to the Past.
- #strong[Legendary lovers, prophecy, or cyclical doom?] Focus on: Historical Figures & Legendary Lovers (especially Legendary Lovers and Cyclical History).
- #strong[Immortal/mortal romance?] Go straight to: Living History: Long-Lived Beings.
- #strong[Hidden identity or suppressed truth?] Focus on: What Survives, What's Lost, and What's Been Hidden (especially Forbidden & Suppressed History).
- #strong[Family opposition or ancestral guilt?] Focus on: Family History & Inherited Wounds (especially Ancestral Legacies and Generational Trauma).
...
#mistake-box(
  title: "Mistake #1: The Irrelevant History",
  fix: [For every historical detail, ask: "How does this affect my characters right now?" If it doesn't create tension, obligation, guilt, fear, or forbidden desire, cut it.],
)[
...
#mistake-box(
  title: "Mistake #2: The Convenient Discovery",
  fix: [Historical discoveries should complicate as much as they clarify. In #emph[Mistborn], discovering the truth about the Lord Ruler doesn't simplify anything; it reveals he was both more sympathetic and more monstrous than anyone believed. In #emph[From Blood and Ash], Poppy's discovery of Hawke's true identity as Casteel doesn't resolve the conflict between their peoples. It detonates it. The history becomes #emph[more] painful once she knows the full truth.],
)[
...
#mistake-box(
  title: "Mistake #3: The Vague Ancient Grudge",
  fix: [Make it specific and recent enough to hurt. In #emph[Fourth Wing], the grudge between Violet and Xaden isn't "the Tyrrish rebellion." It's "your father led the rebellion that got my brother killed." In #emph[The Cruel Prince], Jude's grudge against the fae isn't ancient and vague. It's "Madoc murdered my parents in front of me and then raised me." That specificity is what makes it cut.],
)[
...
#mistake-box(
  title: "Mistake #4: The Static Past",
  fix: [Give your characters different relationships with the same events. Let them argue about what happened, who was to blame, whether it matters. The past should be as contested between them as the present.],
)[
...
Think about the inherent unevenness that exists here. In #emph[ACOTAR], the fae have living witnesses: immortals who personally fought in the war five hundred years ago. Humans have no access to anything except for oral tradition and crumbling records. Feyre's understanding of the war is folklore; Rhysand's is personal memory. Not only are they coming from different sides, they both see the same historical events through completely different perspectives. In #emph[Mistborn], the Lord Ruler had total control of all recorded history but the oral traditions of the skaa documented a different reality. The way that the past was recorded #emph[was] the battle.

#strong[How is history recorded and preserved in your world?]

#hint[The methods your world uses to document history determine what survives, who has access to it, and what your characters can discover. A world that relies on oral tradition loses details but keeps emotional truth. A world with magical archives preserves everything but restricts access. The method shapes the mystery.]
...
#strong[Which method is considered most authoritative?]
...
#workbook-table(
  headers: ("Type", "What They Preserve", "Their Biases"),
  rows: (
...
#strong[Who keeps history in your world?]
...
#strong[What institutions preserve the past?]
...
#open-table(
  headers: ("Institution", "What It Holds", "Who Can Access It"),
  example-rows: (
    ...
    ([Temples/religious centres], [Sacred texts, prophecies, records of divine intervention, moral judgments on historical figures], [Clergy and initiates; pilgrims may hear selected portions; heretical texts are sealed]),
...
#strong[What institutions preserve the past in your world?]


#hint[Fill in the institutions most relevant to your story. Focus on the ones your characters might need to access — or break into.]
...
#strong[What perspectives are missing from official history?]
...
#strong[Are there competing versions of history?]
...
Elite record-keeping is one thing, but what do common people actually #emph[know] about the past? This shapes what your characters "know," and characters raised on songs learn different lessons than characters raised on archives.


#strong[How do most people learn about history?]
...
#strong[Which are most common in your world?]
...
#strong[What history do children learn?]
...
#strong[Is there a gap between elite and common historical knowledge?]
...
#strong[Did your protagonist and love interest learn history through different channels?]
...
#strong[What survives well in your world?]
...
#strong[Does this lost knowledge matter for your story?]
...
Sometimes the most critical information lies hidden. And when we talk about "hidden history," that is like having a loaded gun pointed at your characters' assumptions. Within nearly every romantasy subgenre except for Regency, there exists a fundamental lie that the characters must unmask. In #emph[From Blood and Ash], the entire kingdom of Solis is based on the myth of the Ascension, and when the protagonists learn that the Ascended are actually predatory vampyric creatures, it destroys all of the assumptions that Poppy ever held. In #emph[Fourth Wing], the "official history" taught at Basgiath War College is essentially government propaganda intended to keep its own cadets from discovering the true enemy (venin).


#strong[Is there a historical truth that's been suppressed or rewritten?]
...
#strong[Do your characters discover this hidden history?]
...
#strong[How does learning the truth change everything?]
...
#strong[Which layers of history matter for your story?]
...
#strong[What's the overall arc of your world's history?]
...
#strong[How was your world/nation/society founded?]
...
#strong[What ideals did they establish? Are those ideals still honored or corrupted?]
...
#strong[List 2-4 other events that matter for your story:]


#open-table(
  headers: ("Event", "When", "What Happened", "Current Relevance"),
  example-rows: (
...
#strong[What major conflicts shaped your world?]


#open-table(
  headers: ("Conflict", "Who vs. Who", "Why", "Who Won", "Lasting Effects"),
  example-rows: (
...
#strong[Are any historical conflicts still unresolved?]
...
#strong[What would it mean for them to be together despite this history?]
...
#strong[What historical places matter for your story?]


#open-table(
  headers: ("Place", "What Happened There", "What It Means Now", "How It Affects Your Characters"),
  example-rows: (
    ([e.g., The bridge at Ramiel (ACOTAR)], [Ancient rite of passage for Illyrian warriors], [Sacred, forbidden to outsiders], [Crossing it becomes a test of belonging and worthiness]),
  ),
  rows: (
    ([], [], [], []),
    ([], [], [], []),
...
#strong[Do your characters visit a place where history happened?]
...
#strong[What's your culture's attitude toward the past?]
...
#strong[How do people interact with historical sites?]


#hint[If ruins are sacred, a romantic scene set in one becomes sacrilege. If they're forbidden, meeting there makes your characters outlaws. The way your world treats its historical places determines what it means for your characters to stand in them together.]
...
#strong[Do people venerate ancestors?]


#hint[If your characters' peoples venerate their ancestors, then falling in love with the enemy isn't just a personal betrayal — it's a spiritual one. Ancestor veneration raises the stakes from "my family will be angry" to "my dead grandmother's spirit is watching me betray everything she fought for."]
...
#strong[Are there historical commemorations?]


#hint[Festivals and monuments refresh historical trauma on a schedule. If your world celebrates a victory that was your love interest's people's worst defeat, every anniversary becomes a scene waiting to happen.]
...
The Wall in #emph[ACOTAR] is the most graphic example: a magical barrier that separates the world into two parts and crackles with energy, leaving the tongue coated with the sensation of division. It's not a metaphor for the fae-human divide. It #emph[is] the divide, and every time a character steps across the Wall they are committing a political act. In #emph[Mistborn], the propaganda takes on an environmental form: ash falls from the sky covering Scadrial in grey soot. These ash falls were caused by the Lord Ruler's reshaping of the planet, and he was able to erase the memory of green living things from an entire civilisation. Vin's confusion at hearing of green plants is a direct result of the propaganda working exactly as desired. The Steel Ministry is responsible for "soothing stations" located throughout skaa neighbourhoods where Allomancers maintain the mood of the citizens to inhibit rebellion. These stations create physical spaces where the emotional state of the citizens is manipulated, reduced to a level of complacency, thereby making the thought of resistance feel impossible. In #emph[The Cruel Prince], the topography of Elfhame itself reinforces the social structure of the fae kingdom: the islands are connected by narrow, partially submerged rock paths that require jumping to traverse. This serves as a constant reminder of Jude's mortality compared to the seemingly effortless agility of the fae.


#workbook-table(
  headers: ("Propaganda Type", "How It Works", "What It Creates for Romance"),
  rows: (
    ...
    ([Architectural hierarchy (spires, palaces, slums, restricted zones)], [Physicalises the social order], [Where your characters are #emph[allowed to be] in the landscape reflects the power dynamics of the romance]),
  ),
)


#strong[Map your world's propaganda landscape:]
...
#open-table(
  headers: ("Propaganda Type", "What It Looks Like in Your World", "How It Intrudes on Your Romance"),
  example-rows: (
...
#strong[Does the propaganda landscape intrude on your characters' intimate moments?]


Propaganda landscapes are strongest when they enter into the private realm of a character. When Feyre and Rhysand act out their relationship in the Court of Nightmares in #emph[ACOMAF], it's not just that they're being forced to perform their love for each other; the court itself is a monument to the violence done to them, and their intimacy becomes political theatre. In #emph[Mistborn], Vin's first experiences of romance occur at noble balls, where the grey ashfalls outside contrast with the lavish gowns inside. It creates a moral dissonance she can't ignore.
...
The way for characters to find resistance is to look for the cracks in the wall, the truth beneath the ash, the banned text that tells a different story. Feyre utilises her own art as a means of resistance, painting vivid, misleading images so that she can keep her real emotions hidden. In #emph[Mistborn], the truth is literally etched in metal, a medium that can't be altered by the entity who corrupted the paper records. And in #emph[The Hunger Games], the three-finger salute becomes an organic counter-symbol that outpaces the state's manufactured propaganda.


#strong[What "holes" exist in your world's propaganda?]
...
#workbook-table(
  headers: ("Hero", "What They Did", "How They're Remembered"),
  rows: (
...
#strong[Who are the great villains?]
...
#workbook-table(
  headers: ("Villain", "What They Did", "How They're Remembered"),
  rows: (
...
#strong[Are any of these figures relevant to your characters?]
...
#strong[What famous love story does your culture tell?]


#structured-table(
  headers: ("Aspect", "Legendary Couple 1", "Legendary Couple 2 (if applicable)"),
  example-rows: (
...
#strong[Is the famous love story tragic, triumphant, or cautionary?]
...
#strong[What do your characters know about the legendary couple that others don't?]
...
#strong[Does history repeat in your world?]
...
#strong[Is there a historical parallel to your characters' situation?]
...
#strong[What stories does your protagonist's family tell about themselves?]
...
#strong[What stories does your love interest's family tell?]
...
#strong[What family story has each character never questioned, until now?]
...
#strong[If your characters come from different backgrounds, do they know different histories?]


#open-table(
  headers: ("Event", "Protagonist's Version", "Love Interest's Version"),
  example-rows: (
    ([e.g., The Tyrrish Rebellion (Fourth Wing)], [A treasonous uprising that cost loyal soldiers their lives], [A justified fight for independence that was crushed by a tyrant]),
  ),
  rows: (
    ([], [], []),
    ([], [], []),
...
#strong[What happens when they compare histories?]
...
#strong[Does this recent history create conflict between them?]
...
#strong[Could an heirloom help or hurt their relationship?]
...
#strong[What did your protagonist's ancestors do that affects them now?]
...
#strong[What obligations do they inherit?]
...
#strong[Do ancestral legacies put them in conflict?]
...
#strong[Does bloodline matter in your world?]


Magically? Politically? Socially? Bloodline significance creates stakes for who your characters are #emph[allowed] to love, and what happens if forbidden bloodlines combine.
...
In #emph[Fourth Wing], this is made literal: Xaden has 107 scars on his back, one for every child of the rebellion leaders whose survival he bargained for. His scars are a relic of the rebellion, a constant visual reminder that the Tyrrish conflict isn't abstract history but something carved into his body. Violet grew up as the daughter of the woman who ordered his father's execution. They're on opposite sides of the same wound, and their romance requires navigating that without either minimising the other's pain. In #emph[ACOTAR], the asymmetry is different: Feyre has the inherited fear and dehumanisation of fae that all humans were conditioned to feel through generations of being preyed upon. Rhysand carries centuries of watching humans be dismissed as lesser. Their trauma is asymmetric. They both suffered the same historical wounds, but in different ways.


#strong[What historical trauma does your protagonist carry?]
...
#strong[How does this trauma manifest?]
...
#strong[What historical trauma does your love interest carry?]
...
#strong[How does it manifest in them?]
...
#strong[If their traumas come from the same event but opposite sides, how do they navigate that?]
...
#strong[Can historical wounds be healed, or are they permanent?]
...
#strong[Did either side in historical conflicts commit atrocities?]
...
#strong[Does one character carry guilt for ancestors' actions? Does the other carry rage for ancestors' suffering?]
...
#workbook-table(
  headers: ("Weapon Type", "How It Works", "Example"),
  rows: (
    ([The name as a slur], [A character's family name or heritage is used to reduce them to their ancestors' crimes], [#emph[Fourth Wing]: Xaden uses "Sorrengail" as shorthand for everything the loyalists did to his people; Violet can't escape her mother's legacy]),
    ([Biological othering], [A character's species or mortality is invoked to deny their worth or belonging], [#emph[The Cruel Prince]: Cardan and the Gentry call Jude "mortal," reducing her identity to a biological fact that means she's temporary and lesser]),
    ([The historical trump card], [A character invokes a specific ancestral crime to shut down the argument], [#emph[ACOTAR]: Rhysand's mother and sister were slaughtered by Tamlin's father and brothers, a history that functions as a permanent wedge, thrown in Tamlin's face to justify the Night Court's refusal to trust him]),
    ([Protection as control], [A character uses the historical vulnerability of the other's people to justify limiting their autonomy], [#emph[ACOTAR]: Tamlin weaponises Feyre's human fragility and the looming war with Hybern to justify locking her in the Spring Court. His "protection" becomes a continuation of her imprisonment]),
    ([Inherited identity as accusation], [A character is held responsible for what their people did, regardless of their personal choices], [#emph[Fourth Wing]: Violet enters the Riders Quadrant as the daughter of the woman who ordered Xaden's father's execution. She #emph[is] a Sorrengail before she's anything else]),
    ([Turning the weapon back], [A character accepts the history thrown at them and uses it as strength], [#emph[The Cruel Prince]: Jude tells Madoc "I am what you made me," accepting the ruthlessness he taught her and using it to dismantle his coup]),
  ),
)
...
There is a fascinating theme here. Characters do not actually weaponise history against their opposites. They weaponise it against those who are most like them. A historical grievance attacks the aspects of the self which the character has yet to accept. In #emph[Fourth Wing], Xaden can see his own rebel heart in Violet's stubborn will, and his weaponisation of their opposing histories is a desperate attempt to avoid recognising how much they have in common. In #emph[Bridgerton], Anthony and Kate use their ancestral responsibilities as shields, each accusing the other of being too protective, too dutiful, because they're terrified of admitting they're the same kind of person.
...
#strong[What does their historical weapon reveal about the attacker?]


#hint[The Mirror Effect means characters use the past to attack traits they recognise in themselves. The accusation they throw is a window into what they're most afraid of being. Map the mirror: what does each character accuse the other of, and how is that accusation actually a confession?]


#structured-table(
  headers: ("Character", "The Historical Accusation They Make", "The Trait They're Actually Attacking", "Why They Recognise It (the mirror)"),
  example-rows: (
...
#strong[What historical ammunition does your protagonist carry?]
...
#strong[Is there a moment where one character refuses to flinch?]
...
#workbook-table(
  headers: ("Requirement", "What It Means", "What Happens Without It"),
  rows: (
...
#strong[How does your romance resolve the historical conflict?]
...
#hint[Reconciliation doesn't happen in one scene. It happens through a sequence of small moments where the armour cracks. List 3-5 moments where your characters' inherited enmity erodes — shared danger, unexpected kindness, a moment where one sees the other's humanity despite everything they were taught.]


#structured-table(
  headers: ("Moment", "What Happens", "What Crack It Creates"),
  example-rows: (
    ([e.g., Fourth Wing: Xaden saves Violet during the Gauntlet], [He protects someone he's supposed to hate], [Violet can't reconcile "rebel's son" with the person who saved her life]),
  ),
  rows: (
    ([1.], [], []),
    ([2.], [], []),
...
#strong[What does reconciliation cost your characters?]
...
#workbook-table(
  ...
  rows: (
    ([How does history justify current government?], [], [#emph[ACOTAR]: The Wall and Treaty, born from the ancient war, justify the separation of fae and human territories and the High Lords' authority]),
    ([How does history explain religious beliefs?], [], [#emph[Mistborn]: The Lord Ruler's ascension became the basis of the Steel Ministry's religious authority]),
    ([How does history create cultural attitudes and taboos?], [], [#emph[The Priory of the Orange Tree]: Ancient dragonrider history shapes which cultures revere vs. fear dragons]),
    ([How did magic change history?], [], [#emph[Shadow and Bone]: The creation of the Shadow Fold reshaped Ravkan politics and borders for centuries]),
    ([Could understanding history change how people view your characters' relationship?], [], [#emph[Romeo and Juliet]: If the feud's origin were revealed as trivial, it would reframe the tragedy]),
  ),
)
...
#workbook-table(
  ...
  rows: (
    ([The historical conflict that affects your romance], [], [#emph[ACOTAR]: The ancient war between fae and humans]),
    ([Protagonist's ancestral legacy], [], [#emph[Six of Crows]: Inej's Suli heritage and the cultural weight of her family's traditions]),
    ([Love interest's ancestral legacy], [], [#emph[ACOTAR]: Rhysand's family legacy as High Lord, the weight of the Night Court's history]),
    ([The legendary lovers they're compared to], [], [#emph[The Cruel Prince]: Echoes of past human-fae romances that ended in betrayal]),
    ([The historical parallel (past situations that mirror theirs)], [], [#emph[Priory of the Orange Tree]: Ancient dragonrider bonds that mirror the protagonists' connection]),
    ([The suppressed truth (if any)], [], [#emph[Mistborn]: The true history of the Lord Ruler's ascension, hidden for a thousand years]),
    ([The historical pattern (cycle they're repeating or breaking)], [], [#emph[Shadow and Bone]: The Darkling's repeated pattern of seducing Sun Summoners across centuries]),
    ([How history resolves], [], [#emph[ACOTAR]: The Wall falls; the old separation ends; a new era begins]),
  ),
)
