...
*What does the space force to happen (physical proximity, cooperation, vulnerability)? And what does it prevent (escape, privacy, honesty)?*
...
**Does the magic of this space bypass your characters' defences?** *(Emotion-responsive environments, truth-compelling pools, sin-testing corridors can force a transparency that characters would never choose voluntarily.)*
...
**Does the magic create safety or danger, or both?** *(The best magical locations offer something your characters desperately need while simultaneously taking something away.)*
...
*Transitions aren't dead space — they're the moments where the rules of one space have ended and the rules of the next haven't started yet. Characters are between roles, and that's when the most honest moments slip through. The walk from the ballroom to the garden, the journey from the city to the wilderness, the climb from the base of the tower to the top:*
